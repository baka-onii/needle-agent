...
A small, local-first project for collecting and organizing research notes.

## Project map

- `src/auth.py` — authentication and password verification.
- `src/notes.py` — note titles, tags, and a word-count helper.
